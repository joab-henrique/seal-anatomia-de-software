...
export class IntroWorld {
  ...
  makeScreenTexture() {
    ...
    ctx.fillText('Conheça mais', 57, 303);
    ctx.fillText('sobre a', 57, 375);
    ctx.fillStyle = '#748fc9';
    ctx.fillText('SEAL.', 57 + ctx.measureText('sobre a ').width, 375);
    ctx.fillStyle = '#7d8da9';
    ctx.font = '22px sans-serif';
    ctx.fillText('Aprenda, crie e acompanhe as novidades da liga.', 62, 426);
    ...
    ctx.font = '22px sans-serif';
    ctx.fillText('Quero receber novidades   ↗', 80, 506);
